 ...
 */
function neb(embed: EmbedBuilder, player: Player, client: heemusic, locale: string): EmbedBuilder {
 ...
 */
async function setupStart(client: heemusic, query: string, player: Player, message: Message): Promise<void> {
...
async function updateSetup(client: heemusic, guild: Guild, locale: string): Promise<void> {
